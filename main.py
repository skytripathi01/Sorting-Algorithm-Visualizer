...
Button(UI_frame, text="Current Array",font=('bold'), command=generate, bg='red',height=4).grid(row=0, column=3, padx=5, pady=5)

lowest_Entry = Scale(UI_frame, from_=1, to=200, resolution=1, orient=HORIZONTAL, label="Lower Limit")
lowest_Entry.grid(row=1, column=0, padx=5, pady=5)

highest_Entry = Scale(UI_frame, from_=20, to=500, resolution=1, orient=HORIZONTAL, label="Upper Limit")
highest_Entry.grid(row=1, column=1, padx=5, pady=5)

arrsize_Entry = Scale(UI_frame, from_=5, to=50, resolution=1, orient=HORIZONTAL, label="Array size")
arrsize_Entry.grid(row=1, column=2, padx=5, pady=5)

Button(UI_frame, text="Sort Array",font=('bold'), command=sort, bg='blue',height=4).grid(row=1, column=3, padx=5, pady=5)
